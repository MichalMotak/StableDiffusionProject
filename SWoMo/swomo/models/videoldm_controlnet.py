...
from swomo.models.videoldm_unet_blocks import get_down_block, VideoLDMUNetMidBlock2DCrossAttn
...
class ControlNetModel(ModelMixin, ConfigMixin, FromOriginalControlnetMixin):
    ...
    def from_unet(
        ...
        r"""
        Instantiate a [`ControlNetModel`] from [`VideoLDMUNet3DConditionModel`].
        ...
        controlnet = cls(
            ...
            # conditioning_channels=unet.config.conditioning_channels,
            ...
            # additional
            use_temporal=unet.config.use_temporal,
            n_frames=unet.config.n_frames,
            n_temp_heads=unet.config.n_temp_heads,
            first_frame_condition_mode=unet.config.first_frame_condition_mode,
            augment_temporal_attention=unet.config.augment_temporal_attention,
            temp_pos_embedding=unet.config.temp_pos_embedding,
            use_frame_stride_condition=unet.config.use_frame_stride_condition
        )
    ...
    def forward(
        ...
        assert controlnet_cond.dim() == 5, f"Expected hidden_states to have ndim=5, but got ndim={sample.dim()}."
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        ...
        #TODO: Print for controlnet instead!  (This line only works if loading prettrained controlnet not from unet)
