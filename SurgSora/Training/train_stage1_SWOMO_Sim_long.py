...
from surgora_my_utils import get_cmp_flow, get_dav2_flows, grayscale_to_color_mask, overlay_segmentation, sample_inputs, get_optical_flows, get_optical_flows_main_optimized
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(controlnet):
                ...
                if args.width == 256:
                    ...
                    dsi_mask_spatial = F.interpolate(masks, size=(128, 128), mode='nearest')         
